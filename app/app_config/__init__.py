...
def get_oidc_metadata():
    ...
    return {
        ...
        "credential_endpoint": f"https://{host_ip}:5000/credential",
        "batch_credential_endpoint": f"https://{host_ip}:5000/batch_credential",
        "notification_endpoint": f"https://{host_ip}:5000/notification",
        "deferred_credential_endpoint": f"https://{host_ip}:5000/deferred_credential",
...
def get_openid_configuration():
    ...
    return {
        ...
        "jwks_uri": "https://{host_ip}:5000/static/jwks.json",
        "scopes_supported": [
            "openid"
        ],
        ...
        "issuer": f"https://{host_ip}:5000",
        "registration_endpoint": f"https://{host_ip}:5000/registration",
        "introspection_endpoint": f"https://{host_ip}:5000/introspection",
        "authorization_endpoint": f"https://{host_ip}:5000/authorizationV3",
        "token_endpoint": f"https://{host_ip}:5000/token",
        "userinfo_endpoint": f"https://{host_ip}:5000/userinfo",
        "end_session_endpoint": f"https://{host_ip}:5000/session",
        "pushed_authorization_request_endpoint": f"https://{host_ip}:5000/pushed_authorizationv2",
        "credential_endpoint": f"https://{host_ip}:5000/credential"
    }
